...
/**
 * @description
 * @create 2017-06-15 上午11:31
 * @email spartajet.guo@gmail.com
 */
public class AnglePressureNormalAngle extends ParaAngle implements IAnglePressureNormal {
     ...
     */
    public AnglePressureNormalAngle(boolean fixed, String unit, Angle valueLimitMax, Angle valueLimitMin, int digitsAfterDotSecond) {
    ...
    public void calculateValue(IAngle angleHelix, IAngle anglePressure, TeethNumber teethNumber, ModuleNormal moduleNormal, DiameterBase diameterBase, ModuleBasic moduleBasic, ModuleTransverse moduleTransverse) {
        ...
        if (angleHelix.known() && anglePressure.known() && this.calculationSucceed) {
            ...
            this.refreshValue(new Angle(alphaN));
            this.first = true;
